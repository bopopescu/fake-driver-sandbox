...
# PF9: nova now uses cinderclient to veridy versions, URL and connect to cinder service.
# Keeping this function around in case the changes in this function need to be redone.
# TODO: pacharya: get rid of this function once above verification is complete
...
#         simple_version_match = version in components[1]
#         pf9_version_match = (len(components) >= 3 and components[1] == 'cinder' and version in components[2])
#         if simple_version_match or pf9_version_match:
#             version = version[1:]
#
