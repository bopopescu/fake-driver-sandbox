...
class ComputeAPI(object):
    ...
    def discovery_task_state_pf9(self, ctxt, host):
        version = '4.0'
        cctxt = self.client.prepare(server=host, version=version)
        return cctxt.call(ctxt, 'discovery_task_state_pf9')

    def trigger_discovery_task_pf9(self, ctxt, host):
        version = '4.0'
        cctxt = self.client.prepare(server=host, version=version)
        cctxt.cast(ctxt, 'trigger_discovery_task_pf9')
