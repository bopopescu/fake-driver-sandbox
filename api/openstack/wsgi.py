...
class Request(wsgi.Request):
    ...
    def cache_db_hypervisors(self, hypervisors):
        self.cache_db_items('hypervisors', hypervisors, 'id')

    def get_db_hypervisors(self):
        return self.get_db_items('hypervisors')

    def get_db_hypervisor(self, id):
        return self.get_db_item('hypervisors', id)
