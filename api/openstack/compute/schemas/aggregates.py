...
add_host = {
    ...
    'properties': {
        ...
        'add_host': {
            'type': 'object',
            'properties': {
                # PF9: hostname on VMware is <host_id>:<cluster name>
                # pf9_hostname_or_ip_address parameter type allows ':' and
                # spaces while hostname parameter does not
                'host': parameter_types.pf9_hostname_or_ip_address,
            },
            'required': ['host'],
            'additionalProperties': False,
        },
