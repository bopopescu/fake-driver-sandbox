...
class ImageMetaProps(base.NovaObject):
    ...
    fields = {
        ...
        # PF9 addition
        'pf9_vsphere_template': fields.StringField(),
        'pf9_vsphere_template_uuid': fields.StringField(),
        'pf9_vsphere_template_moref': fields.StringField(),
        'pf9_vsphere_template_name': fields.StringField()
    }
    ...
    def _set_attr_from_pf9_props(self, image_props):
        """
        Adds PF9 specific image properties to image_props_meta object
        This is needed in case of VMware templates only.
        :param image_props: Image properties dict
        :return: None
        """
        pf9_keys = ['pf9_vsphere_template', 'pf9_vsphere_template_name',
                    'pf9_vsphere_template_moref', 'pf9_vsphere_template_uuid']
        for key in pf9_keys:
    ...
    def from_dict(cls, image_props):
        ...
        # pf9 change: add PF9 related properties to images
        obj._set_attr_from_pf9_props(image_props)
        return obj
