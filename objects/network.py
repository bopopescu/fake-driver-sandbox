...
class Network(obj_base.NovaPersistentObject, obj_base.NovaObject,
    ...
    fields = {
        ...
        'range_start': fields.IPAddressField(nullable=True),
        'range_end': fields.IPAddressField(nullable=True),
        }
    ...
    @obj_base.remotable
    def delete_fixed_ips(self, context):
        db.network_delete_fixed_ips(context, self.id)
...
class NetworkList(obj_base.ObjectListBase, obj_base.NovaObject):
    ...
    @obj_base.remotable_classmethod
    def get_by_bridges_pf9(cls, context, bridges, project_only='allow_none'):
        """
        PF9 method
        :param cls:
        :param context:
        ...
        :return:
        """
        db_networks = db.network_get_all_by_bridges(context, bridges,
                                                    project_only=project_only)
        return obj_base.obj_make_list(context, cls(context), objects.Network,
                                      db_networks)

    @obj_base.remotable_classmethod
    def cleanup_pf9(cls, context, host, bridges, node=None):
        """
        PF9 Method. TODO: Move this functionality out into janitor like function
        :param cls:
        :param context:
        :param bridges:
        :return:
        """
        db.network_cleanup(context, host, bridges, node)

    @obj_base.remotable_classmethod
    def get_by_instance_id_pf9(cls, context, instance_id):
        db_networks = db.network_get_all_by_instance_pf9(context, instance_id)
        return obj_base.obj_make_list(context, cls(context), objects.Network,
                                      db_networks)
