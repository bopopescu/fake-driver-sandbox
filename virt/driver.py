...
class ComputeDriver(object):
    ...
    def instance_exists_ex(self, instance):
        """Checks existence of instance on a host
        This is a PF9 function
        :param instance: Instance to lookup
        :return: True if an instance with supplied name exists, false otherwise
    `    """
        raise NotImplementedError()
    ...
    def list_instance_uuids(self, node=None, template_uuids=None, force=False):
        # Pf9 change - added a node and template_uuids parameters.
        # This is only needed by the VMwareVCDriver, others ignore it
        """Return the UUIDS of all the instances known to the virtualization
        layer, as a list.
        """
        raise NotImplementedError()

    # PF9 function for instance discovery
    ...
    def get_all_ip_addr(self):
        """
        Retrieves all (up to 4) IP addresses for multi-nic systems
        """
        raise NotImplementedError()

    def get_pf9_hostid(self):
        """
        Retrieves Platform9 specific unique identifier of host
        """
        raise NotImplementedError()
    # PF9: end
    ...
    # TODO: Pushkar This function has been removed in liberty. Remove it if PF9 is not using it
    ...
    def get_host_stats_pf9(self, res_types, refresh=False, nodename=None):
        """Return currently known physical resource usage
    ...
    def get_all_networks_pf9(self, node=None):
        ...
        """
        Find all bridges/port groups and associated information
        This method call (implemented in drivers) should return following
        object-
            [
                {'bridge': <bridge/network/port group # 1 name>},
                {'bridge': <bridge/network/port group # 2 name>},
                {'bridge': <bridge/network/port group # 3 name>}
            ]
        """
        raise NotImplementedError()
    ...
    def get_all_ip_mapping_pf9(self, needed_uuids=None):
        """
        Get all ip, mac aadresses and networks attached to all the VMs
        This method call (implemented in drivers) should return following
        object-
            {
                'VM_1_UUID': [
        ...
        If needed_uuids is supplied, the underlying driver may choose to
        optimize discovery by only considering those instance UUIDs. For KVM 
        this is not a major issue, but on a large VMWare cluster we gain
        a major efficiency.
        """
        raise NotImplementedError()
