...
class API(base_api.NetworkAPI):
    ...
    def _create_port(self, port_client, instance, network_id, port_req_body,
        ...
        try:
            ...
            # PF9 Begin - Send instance name in Port create to neutron for VM DNS name resolution
        ...
        for request in ordered_networks:
            ...
            try:
                ...
                if request.port_id:
                    ...
                    # PF9 Begin
                    # If we attach new VM on existing port, set new dns_name
                    port_req_body['port']['dns_name'] = instance.hostname
                    # PF9 End
    ...
    def validate_networks(self, context, requested_networks, num_instances):
        ...
        # PF9 Begin - IAAS 5415
        # Return if no networks, so VM discovery does not fail with exception
        # This is also what nova networks API does
        if requested_networks is None or len(requested_networks) == 0:
            LOG.debug('No networks to validate')
            return
        # PF9 End
    ...
    def get_vifs_by_instance(self, context, instance):
        #PF9 : Our pf9 code calls this which isn't implemented in neutron.
        # Raising error causes problems with live-migration
    ...
    # PF9 change
    # Stub network discovery methods and utilities for Neutron
    # to minimize logging noise
