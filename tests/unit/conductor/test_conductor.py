...
class ConductorAPITestCase(_BaseTestCase, test.TestCase):
    ...
    def test_register_instance(self):
        ...
        self.conductor_manager.instance_register(
            self.context.elevated(), 'fake-host', updates)
        instances = objects.InstanceList.get_by_host(self.context, 'fake-host')
        self.assertEqual(len(instances), 1)
        str_uuid = instances[0]['uuid']
        self.assertEqual(str_uuid, instance_uuid)
