...
def getVersion():
    """
    (Platform9) This fakelibvirt module will not exercise
    the code path used by earlier versions of libvirt with
    a bug that blocks DHCP traffic. See IAAS-1236.
    """
    return 9012
