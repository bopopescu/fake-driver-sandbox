...
class VMwareVMUtilTestCase(test.NoDBTestCase):
    ...
    def _test_get_stats_from_cluster(self, connection_state="connected",
        ...
        # PF9 start: Carrying forward the changes from Juno merge
        ...
        prop_dict = {'host': hosts, 'resourcePool': respool,
                     'summary': {
                         ...
                         'numCpuThreads':0,
                         'numEffectiveHosts':0,
                         'totalMemory':5120 * 1024 ** 2,
                         'effectiveMemory':0,
                         'effectiveCpu':10000,
                         'totalCpu':1024 * sockets * cores
                     },
                     'quickStats':{
    ...
    def _create_vm_config_spec(self):
        # PF9: handle extension registration failures
        ...
        spec.managedBy.extensionKey = 'platform9.openstack.compute'
    ...
    def test_get_vm_create_spec_with_allocations(self):
        ...
        expected.managedBy.extensionKey = 'platform9.openstack.compute'
