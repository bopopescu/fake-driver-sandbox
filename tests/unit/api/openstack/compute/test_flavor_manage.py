...
# <<<<<<< HEAD:nova/tests/unit/api/openstack/compute/test_flavor_manage.py
...
#         # PF9 change. For some reason there is a typo in flavor comes out as 'flavour'
#         self.assertIn('Unable to create', res.body)
# >>>>>>> atherton:nova/tests/api/openstack/compute/contrib/test_flavor_manage.py
