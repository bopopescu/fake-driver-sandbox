...
"""
These tests are disabled due to failure in Platform9 build system
https://platform9.atlassian.net/browse/IAAS-155
the run_test script uses "subunit.run discover" to discover and run the tests
The discover module by default looks at all the files, but gives a way for the
module to override the what TestSuite/TestCases to run, we are overriding that
behavior here by returning a dummy TestSuite and hence ignoring the test cases
"""
