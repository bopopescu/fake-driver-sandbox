...
class CellsConductorAPIRPCRedirect(test.NoDBTestCase):
    ...
    @mock.patch.object(compute_api.API, 'pf9_get_total_disk_size')
    def test_build_instances(self, pf9_get_total_disk_size, _checks_for_create_and_rebuild,
        ...
        pf9_get_total_disk_size.return_value = 1.0
