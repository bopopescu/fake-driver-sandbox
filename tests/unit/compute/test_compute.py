...
class BaseTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        def fake_sync_nw(context, all_net):
            pass

        self.stubs.Set(self.compute, '_sync_network_info', fake_sync_nw)
...
class ComputeTestCase(BaseTestCase):
    ...
    @testtools.skip('PF9- skipping. Need to fix this')
    @mock.patch('nova.compute.manager.ComputeManager._remove_instances_not_on_driver')
    @mock.patch('nova.compute.manager.ComputeManager._sync_network_info')
    ...
    @testtools.skip('http://platform9.altassian.net/browse/IAAS-288')
    ...
    @testtools.skip('https://platform9.atlassian.net/browse/IAAS-2928')
    ...
    def test_cleanup_running_deleted_instances_log(self):
        """
        PF9 function
        """
        ctxt, inst1, inst2 = self._test_cleanup_running('log')
        self.mox.ReplayAll()
        self.compute._cleanup_running_deleted_instances(ctxt)
