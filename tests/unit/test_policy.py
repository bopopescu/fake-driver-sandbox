...
'compute_extension:pf9_network_access',
'compute_extension:pf9_network_actions',
'compute_extension:pf9_virtual_interfaces',
'os_compute_api:OS-EXT-PF9-network-access:addProject',
'os_compute_api:OS-EXT-PF9-network-access:removeProject',
'os_compute_api:OS-EXT-PF9-network-actions:deleteFixedIPs',
'os_compute_api:OS-EXT-PF9-virtual-interfaces:removeVif',
'os_compute_api:OS-PF9-EXT-INSTANCE-OWNERSHIP:changeOwner')
    ...
    def test_rule_missing(self):
        ...
        result = set(rules.keys()) - set(self.admin_only_rules +
            ...
            self.non_admin_only_rules + special_rules + self.pf9_rules) # Add PF9 rules
