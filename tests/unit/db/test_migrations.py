...
class NovaMigrationsCheckers(test_migrations.ModelsMigrationsSync,
    ...
    @testtools.skip('https://platform9.atlassian.net/browse/IAAS-5011')
    def test_models_sync(self):
        # PF9 change: this test fails since it tries to drop sqlite_sequence table which is not allowed
        pass
