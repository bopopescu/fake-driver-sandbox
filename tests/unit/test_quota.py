...
class QuotaIntegrationTestCase(test.TestCase):
    ...
    def _create_instance(self, cores=2, root_gb=0):
        ...
        inst['vcpus'] = cores
        inst['root_gb'] = root_gb # Pf9 change
    ...
    def test_pf9_too_much_storage(self):
        # default max is 100Gb, m1.small takes 20Gb
        instance = self._create_instance(root_gb=90)
        inst_type = flavors.get_flavor_by_name('m1.small')
    ...
    def test_pf9_enough_storage(self):
        # default max is 100Gb, m1.small takes 20Gb
        instance = self._create_instance(root_gb=80)
        inst_type = flavors.get_flavor_by_name('m1.small')
...
class DbQuotaDriverTestCase(test.TestCase):
    ...
    def test_get_project_quotas_with_remains(self):
        ...
        self.assertEqual(result, dict(
                ...
                # PF9: handle storage quotas being updated
                root_gb=dict(
                    limit=200,
                    in_use=0,
                    reserved=0,
