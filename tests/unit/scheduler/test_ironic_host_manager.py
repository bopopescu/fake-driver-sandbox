...
class IronicHostManagerTestCase(test.NoDBTestCase):
    ...
    @mock.patch('nova.db.compute_node_get_all_networks_pf9',
                return_value=[])
    def test_get_all_host_states(self, mock_gbh, mock_networks_pf9):
        ...
        # PF9: change 0 to 4 in call below for compute<->network association
        self.assertEqual(4, mock_gbh.call_count)
...
class IronicHostManagerChangedNodesTestCase(test.NoDBTestCase):
    ...
    @mock.patch('nova.db.compute_node_get_all_networks_pf9',
                return_value=[])
    def test_get_all_host_states_after_delete_one(self, mock_network):
        context = 'fake_context'
    ...
    @mock.patch('nova.db.compute_node_get_all_networks_pf9',
                return_value=[])
    def test_get_all_host_states_after_delete_all(self, mock_obj):
        context = 'fake_context'
