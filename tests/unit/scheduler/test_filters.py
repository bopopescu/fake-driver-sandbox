...
class FiltersTestCase(test.NoDBTestCase):
    ...
    def test_filter_all(self):
        ...
        base_filter._filter_one('obj1', filter_properties,
                                filter_errors={}).AndReturn(True)
        base_filter._filter_one('obj2', filter_properties,
                                filter_errors={}).AndReturn(False)
        base_filter._filter_one('obj3', filter_properties,
                                filter_errors={}).AndReturn(True)
    ...
    def test_filter_all_recursive_yields(self):
        ...
        # times.
        # PF9 changes: pass in filter_errors dict to handle scheduler errors
    ...
    def test_get_filtered_objects_info_log_none_returned(self):
        ...
        class FilterA(filters.BaseFilter):
            # PF9: pass in filter_errors dict to handle scheduler errors
            def filter_all(self, list_objs, filter_properties, filter_errors={}):
