...
class BaseFilter(object):
    ...
    def filter_all(self, filter_obj_list, filter_properties, filter_errors={}):
    ...
    @staticmethod
    def mark_filter_error(filter_name, filter_errors):
        if filter_name not in filter_errors.keys():
            filter_errors[filter_name] = 0
        filter_errors[filter_name] += 1
...
class BaseFilterHandler(loadables.BaseLoader):
    ...
    def get_filtered_objects(self, filters, objs, filter_properties, index=0, filter_errors={}):
        list_objs = list(objs)
